...
def getClues(guess, secret_num):
    ...
    for i in range(len(guess)):
        ...
        # Правильная цифра на правильном месте.
            ...
            clues.append('одно число, точно находится на правильном месте;')
        elif guess[i] in secret_num:
            # Правильная цифра на НЕправильном месте.
            #print(" ЕСТЬ Правильная цифра на НЕправильном месте.")
            clues.append('одно число, точно есть в загаданном числе, но находится в НЕ правильном месте;')
        else:
            clues.append('одно число, точно НЕТ в загаданном числе;')
    if len(clues) == 0:
        return 'Bagels'  # правильных цифр НЕТ
    else:
